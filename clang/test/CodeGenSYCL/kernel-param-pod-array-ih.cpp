...
// CHECK-NEXT:   { kernel_param_kind_t::kind_std_layout, 4, 4, (param_omit_table[1] << 0)},
// CHECK-NEXT:   { kernel_param_kind_t::kind_std_layout, 4, 8, (param_omit_table[2] << 0)},
// CHECK-NEXT:   { kernel_param_kind_t::kind_std_layout, 4, 12, (param_omit_table[3] << 0)},
// CHECK-NEXT:   { kernel_param_kind_t::kind_std_layout, 4, 16, (param_omit_table[4] << 0)},
// CHECK-EMPTY:
// CHECK-NEXT: };
